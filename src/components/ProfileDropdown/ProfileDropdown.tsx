   ...
   <>
    ...
    {isOpen && (
      <div role="menu" className='absolute border border-slate-200 top-12 right-0 w-48 bg-white dark:bg-gray-800 dark:border-gray-700 rounded shadow-sm py-2'>
        <Link href="/profile" className='block px-4 py-2 text-sm font-medium text-gray-700 dark:dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900'>View Profile</Link>
